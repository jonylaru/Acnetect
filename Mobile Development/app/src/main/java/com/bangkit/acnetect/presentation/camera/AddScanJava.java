package com.bangkit.acnetect.presentation.camera;
...
import com.bangkit.acnetect.ml.Model;

public class AddScanJava extends AppCompatActivity {
    ...
    public void classifyImage(Bitmap image){
        try {
            ...
            String[] classes = {"Blackhead", "Postule", "Nodule"};
